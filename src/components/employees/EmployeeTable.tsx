...
import { presenceStyles, roleStyles } from "@/constants/employee.constants";
          ...
          {employee.map((emp) => (
            <tr
              ...
              className={`border-b border-border last:border-b-0 ${
                emp.status === "On Leave" ? "bg-gray-200 text-gray-500" : ""
              }`}
            >
              {/* Employee */}
              ...
              <td className="px-6 py-4">
                <div className="relative inline-block w-36">
                  <select
                    ...
                    className="w-full appearance-none rounded-lg border border-border bg-background px-3 py-2 pr-8 text-sm outline-none focus:ring-1 focus:ring-primary"
                  >
